/// A module that provides utilities for color management.
///
/// This module includes a function to convert a hex color string to an RGBA tuple.
///
...
/// # Returns
///
/// A `Result<(u8, u8, u8, f32), String>` representing the RGBA values if the conversion is successful,
